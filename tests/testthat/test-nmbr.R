test_that("nmbr works for scalar values", {
  ...
  expect_equal(nmbr(-12345.6789, accuracy = 0.01, html = TRUE, prefix = "$"),
               "&minus;$12&#x202F;345.68")
...
test_that("nmbr works for vector formatting options", {
  expect_equal(nmbr(c(0.123456, -123.456, 123456)), c("0", "\u2212123", "123\u202F456"))
...
test_that("create_nmbr works", {
  f <- create_nmbr()
  expect_equal(f(c(0.123456, -123.456, 123456)), c("0", "\u2212123", "123\u202F456"))
  f <- create_nmbr(accuracy = c(0.01, 0.1, 100))
  expect_equal(f(c(0.123456, -123.456, 123456)), c("0.12", "\u2212123.5", "123\u202F500"))
  ...
  expect_equal(f(c(0.123456, -1234.56, 123456)), c("0/12", "\u22121 234,56", "123,456.00"))
})
